...
export class FetchHistoricalFundamentalsUsecase {
  constructor(
  ...
  async execute(): Promise<void> {
    this.logger.info('Starting to fetch historical fundamentals data...');
    ...
    this.logger.info('Finished fetching historical fundamentals data.');
  }
