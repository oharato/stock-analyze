/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6bad668baec7492ddcfdb079b339979f)
...
declare namespace Cloudflare {
	...
	interface Env {
		R2_BUCKET_NAME: "stock-analyze-data";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_BUCKET_NAME">> {}
}
