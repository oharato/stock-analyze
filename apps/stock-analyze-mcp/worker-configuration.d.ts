/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fdc86a2be2e98b6e98b38c6ec89cf201)
// Runtime types generated with workerd@1.20251202.0 2025-12-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "McpServer";
	}
	interface Env {
		R2_ENDPOINT: string;
		...
		MCP_SERVER: DurableObjectNamespace<import("./src/index").McpServer>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_ENDPOINT" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "CLOUDFLARE_ACCOUNT_ID" | "R2_BUCKET_NAME">> {}
}
