...
Logs are subject to the same [limits as Worker logs](/workers/observability/logs/workers-logs/#limits), which means that they are retained for 3 days on Free plans and 7 days on Paid plans.

See [Workers Logs Pricing](/workers/observability/logs/workers-logs/#pricing) for details on cost.

If you are an Enterprise user, you are able to export container logs via [Logpush](/logs/logpush/) to your preferred destination.
...
You can use [Worker Secrets](/workers/configuration/secrets/) or the [Secrets Store](/secrets-store/integrations/workers/) to define secrets for your Workers.
...
[Edit page](https://github.com/cloudflare/cloudflare-docs/edit/production/src/content/docs/containers/faq.mdx)

Last updated: Sep 22, 2025

[Previous  
Beta Info & Roadmap](/containers/beta-info/) [Next  
Pricing](/containers/pricing/)
